...
function App() {
  ...
  const [selectedPlatform , onSelectPlatform] = useState<Platform | null>(null);
  ...
  return (
    ...
    >
      ...
      <GridItem bg={"black"} area={"main"}>
        <PlatformList selectedPlatform={selectedPlatform} onSelectPlatform={(platform) => onSelectPlatform(platform)} />
